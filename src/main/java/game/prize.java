...
abstract class Prize{
	...
	*/
	...
	getShape:
	Pre-cond: none
	Post-cond: return the shape of Prize object
	*/
	protected char getShape(){
		return this.PrizeShape;
	}
	...
	*/
	...
	/*
	setShape:
	Pre-cond: requires the new shape
	Post-cond: update the shape of the Prize object
		return true if success, false otherwise
	*/
	protected boolean setShape(char shape){
		this.PrizeShape = shape;
		if(this.PrizeShape != shape){
			return false;
		}
		return true;
	}
